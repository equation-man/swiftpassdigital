...
import {
    LOGIN_FAILURE, LOGIN_START,
    LOGIN_SUCCESS, LOGOUT_FAILURE,
    LOGOUT_START, LOGOUT_SUCCESS
} from "../constants/authConstants";

// Funciton declarations which have the responsibility to create an action.
export const loginStart = () => ({type: LOGIN_START});
export const logoutSuccess = (token: string) => ({type: LOGIN_SUCCESS, payload: token });

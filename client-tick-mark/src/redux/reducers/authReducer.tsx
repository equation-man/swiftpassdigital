...
import {
    AuthActionTypes, LOGIN_SUCCESS, LOGIN_FAILURE,
    LOGIN_START, LOGOUT_SUCCESS, LOGOUT_FAILURE
} from "../constants/authConstants";

const authReducer = (state: AuthState=authInitialState, action: AuthActionTypes) => {
    switch (action.type) {
        case LOGIN_START:

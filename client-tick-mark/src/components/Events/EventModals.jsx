...
const TicketPaymentModal = ({ ticketId, eventDetails }) => {
    ...
    const mutation = useMutation({
        ...
        onError: (err) => {
            console.log("Error during ticket purchase:", err);
    ...
    const handleContactSubmission = async (event) => {
        ...
        const payload = { orderDet: { ...inputs, user_contact: phone }, ticketId };
                    ...
                    <dialog className="relative bg-neutral-50 w-96 py-6 mx-2 flex flex-col items-center shadow-lg rounded-sm">
                        <div className="flex flex-col items-center justify-center">
                            <h3 className="font-bold text-gray-700 text-md">
                                Ticket payment and contact details
                            </h3>
                            ...
                            <div className="px-2">
                                <form id="contactForm" onSubmit={handleContactSubmission}>
                                    ...
                                    <div className="w-full">
                                        <label className="font-medium text-gray-600">
                                            Phone contact (with country code)
                                        </label>
                                        <PhoneInput
                                            country={"ke"}
                                            value={phone}
                        ...
                        <div>
                                ...
                                <div className="flex flex-row items-center justify-center text-emerald-600 gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 24 24">
                                        <rect width={6} height={14} x={1} y={4} fill="currentColor">
                                            <animate fill="freeze" attributeName="y" dur="0.75s" values="1;5"></animate>
                                            <animate fill="freeze" attributeName="height" dur="0.75s" values="22;14"></animate>
                                            <animate fill="freeze" attributeName="opacity" dur="0.75s" values="1;0.2"></animate>
                                        </rect>
                            ...
                            {mutation.isError && (
                                <p className="text-rose-500">Error! Failed processing ticket</p>
                            )}
                        </div>

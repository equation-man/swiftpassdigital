...
const Event = ({ evnt }) => {
  ...
  const handleReports = (event) => {
    event.preventDefault();
    router.push(`/organizations/${id}/${evnt.event_id}`);
  }
            ...
            <div className="w-full mt-2">
              <div className="w-full my-1">
                <button
                  ...
                  className="btn btn-block px-4 py-1 bg-teal-700 font-semibold rounded-sm hover:cursor-pointer text-white w-full flex flex-row items-center gap-x-2 hover:bg-emerald-500"
                >

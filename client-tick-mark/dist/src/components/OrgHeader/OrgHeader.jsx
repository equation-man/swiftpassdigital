    ...
    return (<div className="p-2">
            <div className="my-2">
                ...
                <div className="flex flex-row gap-x-2">
                    <button onClick={handleManageAccount} className="text-emerald-700 hover:cursor-pointer font-medium rounded-xs border border-emerald-600 text-xs p-1">
                        Manage Account
                    </button>
                    <button onClick={e => handleCreateEventModDisp(e, true)} className="bg-emerald-700 text-white font-medium text-xs p-1 rounded-xs hover:cursor-pointer">
                        Create New Event
                    </button>
                </div>
            </div>

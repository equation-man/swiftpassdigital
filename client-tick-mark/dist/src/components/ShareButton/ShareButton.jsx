...
export default function ShareButton({ title, shareUrl, message }) {
    ...
    return (<div className="flex flex-col items-start gap-3">
      <button onClick={handleShare} className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs  px-2 py-1 rounded-md transition-all">
        <Share2 className="w-4 h-4"/>
        Share
      </button>

      {showFallback && (<div className="flex items-center gap-3 mt-2">

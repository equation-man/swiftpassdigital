            ...
            {fetch_states && (<div className="flex justify-center items-center fixed z-50 inset-0 backdrop-blur-sm">
                    <dialog className="relative bg-neutral-50 w-96 py-6 mx-2 flex flex-col items-center shadow-lg rounded-sm">
                            ...
                            <div className="px-2">
                                <form id="eventForm" onSubmit={handleCreateEventSubmission} className="w-90">
                                    ...
                                    <div>
                                        ...
                                        <textarea onChange={handleChange} id="description" rows="7" name="description" className="input validator w-full" type="email" required placeholder="Tell people about the event."></textarea>
                                    </div>
                        ...
                        <div className="text-white flex flex-row gap-x-3 w-full p-2">
                            <button onClick={e => handleCreateEventModDisp(e, false)} className="bg-emerald-500 btn-block p-2 hover:cursor-pointer">
                                Cancel
                            </button>
                            <button type="submit" form="eventForm" className="bg-emerald-800 btn-block p-2 hover:cursor-pointer">
                                Generate ticket
                            </button>
                        </div>
                    </dialog>

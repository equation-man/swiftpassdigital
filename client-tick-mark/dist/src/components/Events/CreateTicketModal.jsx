            ...
            {fetch_states && (<div className="flex justify-center items-center fixed z-50 inset-0 backdrop-blur-sm">
                    <dialog className="relative bg-neutral-50 w-96 py-6 mx-2 flex flex-col items-center shadow-lg rounded-sm">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <h1 className="font-bold text-lg">{eventDetails === null || eventDetails === void 0 ? void 0 : eventDetails.title}</h1>
                            <div className="px-2">
                                <form id="createTicketForm" onSubmit={handleTicketSubmission}>
                                    ...
                                    <div>
                                        ...
                                        <textarea onChange={handleChange} id="description" rows="7" name="description" className="input validator w-full" type="email" required placeholder="Ticket description. Give a brief description for the ticket"></textarea>
                        ...
                        <div className="text-white flex flex-row gap-x-3 w-full p-2">
                            <button onClick={e => handleCreateTicketModDisp(e, false)} className="bg-emerald-500 btn-block p-2 hover:cursor-pointer">
                                Cancel
                            </button>
                            <button type="submit" form="createTicketForm" className="bg-emerald-800 btn-block p-2 hover:cursor-pointer">
                                Continue
                            </button>
                        </div>
                    </dialog>

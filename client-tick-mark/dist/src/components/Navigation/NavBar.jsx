            ...
            <div className="flex flex-row items-center justify-between p-2">
                <div>
                    <Link href="/" className="flex flex-row items-center">
                        <Image src="/logo-files/transp-swiftpass-logo.png" width={40} height={40} alt="SwiftPassDigital logo"/>
                ...
                <div className="flex flex-row items-center gap-x-1">
                    ...
                    <button onClick={handleRouteToDashboard} className="rounded-sm text-emerald-800 hover:cursor-pointer">
